...
function gan(index){
    hienthi='Câu'+(index+1) +'. '+questions[index].question;
    stt1='A.'+questions[index].traloi[0];
    stt2='B.'+questions[index].traloi[1];
    stt3='C.'+questions[index].traloi[2];
    stt4='D.'+questions[index].traloi[3];
    document.getElementById('hienthi').innerText=hienthi;
    document.getElementById('op1').innerText=stt1;
    document.getElementById('op2').innerText=stt2;
    document.getElementById('op3').innerText=stt3;
    document.getElementById('op4').innerText=stt4;
...
function k()
{
    $('.none-tap').css('display','block');
    $('.none2-tap').css('display','none');
}